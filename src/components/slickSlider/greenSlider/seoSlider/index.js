                            ...
                            <div className="mx-auto">
                                <div className={styles.container}>
                                    <div className='grid grid-cols-1 md:grid-cols-2 2xl:gap-20 items-center pb-10 md:pb-0'>
                                        ...
                                        <div>
                                            <img className="w-3/4 md:w-full " src={SEO_svg01} alt="video Graphic01" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section>
                            <div className="mx-auto">
                                <div className={styles.container}>
                                    <div className='grid grid-cols-1 md:grid-cols-2 2xl:gap-20 items-center pb-10 md:pb-0'>
                                        <div>
                                            <img className="w-3/4 md:w-full" src={SEO_svg02} alt="video Graphic01" />
                                        </div>
                            ...
                            <div className="mx-auto">
                                <div className={styles.container}>
                                    <div className='grid grid-cols-1 md:grid-cols-2 2xl:gap-20 items-center pb-10 md:pb-0'>
                                        ...
                                        <div>
                                            <img className="w-3/4 md:w-full" src={SEO_svg03} alt="video Graphic01" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section>
                            <div className="mx-auto">
                                <div className={styles.container}>
                                    <div className='grid grid-cols-1 md:grid-cols-2 2xl:gap-20 items-center pb-10 md:pb-0'>
                                        <div>
                                            <img className="w-3/4 md:w-full" src={SEO_svg04} alt="video Graphic01" />
                                        </div>
