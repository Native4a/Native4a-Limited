...
const PriceOne = () => {
    ...
    const features = [
        ...
        t('pricing.pricingOne.feature3'),
        t('pricing.pricingOne.feature4'),
        t('pricing.pricingOne.feature5'),
        t('pricing.pricingOne.feature6'),
        t('pricing.pricingOne.feature7'),
        t('pricing.pricingOne.feature8'),
        t('pricing.pricingOne.feature9'),
        t('pricing.pricingOne.feature10'),
        t('pricing.pricingOne.feature11'),
        t('pricing.pricingOne.feature12'),
    ]
    ...
    return (
        <div className="grid gap-6 text-4xl border rounded-xl bg-white pb-10">
            ...
            <div className="text-center mt-5">
                ...
                <span className="text-5xl font-semibold text-neutral-800">{t('pricing.pricingOne.price')}</span>
