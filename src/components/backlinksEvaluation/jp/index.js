...
import useJpBacklinksEvaluation from '../../../hook/useJpBacklinksEvaluation'

const JpBacklinksEvaluation = ({ className1, className2 }) => {
  const beql = useJpBacklinksEvaluation()
  const cn1 =
    'flex justify-center rounded-xl items-center text-white m-6 p-6 relative top-14 z-10 bg-[#FF6B35]'
  const cn2 =
...
export default JpBacklinksEvaluation
