...
const Form: React.FC = () => {
  ...
  const contactForm = useContactForm() as ContactFormItem[]
            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <label className="block">
                <select
                  ...
                  id="usenquiryService"
                  className="p-3 my-4 block w-full rounded-md shadow-sm"
                  defaultValue={fieldServices[0]}
                  required
                >
                  <option value={fieldServices[0]}>{fieldServices[0]}</option>
              ...
              <label className="block">
                <select
                  ...
                  id="findUs"
                  className="p-3 my-4 block w-full rounded-md shadow-sm"
                  defaultValue={fieldFindus[0]}
                  required
                >
                  <option value={fieldFindus[0]}>{fieldFindus[0]}</option>
