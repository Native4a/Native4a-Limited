    ...
    <nav className="flex justify-center m-auto">
      ...
      >
        ...
        <div className="xl:hidden col-start-5 col-end-11 sm:col-start-6 sm:col-end-12 flex items-center justify-end">
          {/* 備註：這是手機版的WhatsApp */}
          <Whatsapp linkto="https://api.whatsapp.com/send/?phone=85267461301&text=你好，我想查詢______服務。">
            WhatsApp查詢
          </Whatsapp>
        </div>
          ...
          <nav className="flex justify-around bg-[#1d1d1d]/90 rounded-full p-2 content-center justify-items-center backdrop-blur-[10px] gap-3">
            ...
            >
              <svg
                ...
                viewBox="0 0 377.96 335.92"
                className={styles.materialIcons}
              >
                <path
                  className={styles.st0}
                  d="M325.67,159.37v166.55h-97.19l-.81-99.55c-2.5-20.08-20.1-35.07-40.2-34.37-19.93,.69-36.35,16.58-37.7,36.59l-.22,97.33H51.72l-.25-165.47v165.47"
                />
                <path
                  className={styles.st0}
                  d="M10,140.34C69.45,96.89,128.9,53.45,188.35,10c59.87,43.56,119.74,87.11,179.61,130.67"
                />
              </svg>
