                ...
                {clients.map((item, index) => {
                    ...
                    return (
                        <div key={index}>
                            <Popup
                                trigger={
                                    <div className={styles.overlay_container}>
                                        <img src={mainVisual.url} alt="YouTube video" width="500" height="600" className="rounded-sm" loading="lazy" decoding="async" />
                                    </div>
                                }
                                modal
                                contentStyle=""
                            ...
                            <p className="text-md mt-4 text-center px-6 py-1 bg-amber-500 rounded-full font-bold">{clientFeedback.clientFeedback}</p>
                            <div className="w-10/12 m-5">
                                <div className="grid grid-cols-3 gap-4 items-center">
                                    <div className="">
                                        <img className="col-end-3 rounded-full" src={companyLogo.url} alt="service_Video_Production" loading="lazy" decoding="async" />
                                    </div>
                                    <div className="col-span-2">
                                        <div className="pl-4 col-start-3 col-end-9">
                                            <p><b>{clientsName}</b></p>
                                            <p className="text-sm">{companyName} {clientsPosition}</p>
                                            <StarRatings
                                                rating={ranking}
