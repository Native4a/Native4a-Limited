...
const OffPageIndex = ({ location }: { location: any }) => {
  ...
  return (
    <BacklinkLayout location={location}>
      <Seo
        title={t('offpage.metaTitle')}
        description={t('offpage.metaDescription')}
            ...
            <div className="flex justify-center items-center p-6">
              <div className="pt-2 md:pt-3 2xl:pt-0">
                ...
                <Text tag="h2" className="tracking-tight font-black text-xl">
                  <p>
                    <b className="bg-[#FFC107]">{t('offpage.heroSubtitleHighlight')}</b>
                    {t('offpage.heroSubtitle')}
                  </p>
                </Text>
                <div className={styles.border}></div>
                <p className="py-5 md:py-3 text-lg md:text-lg 2xl:text-2xl">
                  {t('offpage.heroDescription')}
                </p>
              </div>
            </div>
      ...
      <section className="bg-[#608A51]">
        <div className="container mx-auto grid text-white place-content-center pt-8 lg:pt-24">
          <h2 className="text-[1.7rem] text-center lg:text-left md:text-5xl font-black leading-tight lg:leading-loose">
            {t('offpage.section2Title')}<p>{t('offpage.section2Subtitle')}</p>
          </h2>
          <p className="text-lg md:text-2xl leading-normal lg:leading-loose px-10 lg:p-0">
            {t('offpage.section2Description')}
          </p>
        </div>
        <div className="container mx-auto lg:relative top-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-8 py-12 lg:p-0 items-end text-xl font-black text-white">
            ...
            >
              {t('offpage.btnChineseOffPagePricing')}
            </Button>
            <Anchor
              to="#Backlink_ref"
              className="flex justify-center rounded-xl bg-amber-500 py-3 px-5 text-white"
            >
              {t('offpage.btnChineseOffPageCases')}
            </Anchor>
          </div>
        </div>
      </section>

      {/* Off-Page Evaluation Section */}
      ...
      <section className="mx-auto" id="Backlink_ref">
        ...
        <div className="mx-auto">
          <div className="flex justify-center items-center backdrop-blur-md bg-[#FAAB00] text-white text-xl text-center font-semibold p-10">
            {t('offpage.successCasesSubtitle')}
          </div>
        </div>
            ...
            <div className="order-2 lg:order-1 flex flex-col justify-center">
              <h2 className="text-2xl lg:text-3xl font-bold text-white mb-4">
                <span className="flex items-center gap-3 mb-4">
                  ...
                  {t('offpage.successCase1')}
                </span>
              </h2>
              <p className="text-white text-lg lg:text-xl font-semibold">{t('offpage.keyword')} {t('offpage.keywordInteriorDesign')}</p>
            </div>
            <div className="order-1 lg:order-2 lg:col-span-2">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div className="bg-white rounded-lg p-6">
                  <div className="bg-blue-500 text-white text-center py-3 rounded-lg mb-4 font-semibold">
                    {t('offpage.withoutChineseOffPage')}
                  </div>
                  <div className="text-center">
                    <p className="text-gray-600 mb-2 text-sm">{t('offpage.googleRanking')}</p>
                ...
                <div className="bg-white rounded-lg p-6">
                  <div className="bg-amber-400 text-white text-center py-3 rounded-lg mb-4 font-semibold">
                    {t('offpage.afterBuyingChineseOffPage')}
                  </div>
                  <div className="text-center">
                    <p className="text-gray-600 mb-2 text-sm">{t('offpage.googleRanking')}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            <div className="order-2 lg:order-1 flex flex-col justify-center">
              <h2 className="text-2xl lg:text-3xl font-bold text-white mb-4">
                <span className="flex items-center gap-3 mb-4">
                  <FaSquare style={{ color: '#FAAB00' }} />
                  {t('offpage.successCase2')}
                </span>
              </h2>
              <p className="text-white text-lg lg:text-xl font-semibold">{t('offpage.keyword')} {t('offpage.keywordMattress')}</p>
            </div>
            <div className="order-1 lg:order-2 lg:col-span-2">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div className="bg-white rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            <div className="order-2 lg:order-1 flex flex-col justify-center">
              <h2 className="text-2xl lg:text-3xl font-bold text-white mb-4">
                <span className="flex items-center gap-3 mb-4">
                  <FaSquare style={{ color: '#FAAB00' }} />
                  {t('offpage.successCase3')}
                </span>
              </h2>
              <p className="text-white text-lg lg:text-xl font-semibold">{t('offpage.keyword')} {t('offpage.keywordWheelchair')}</p>
            </div>
            <div className="order-1 lg:order-2 lg:col-span-2">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div className="bg-white rounded-lg p-6">
      ...
      <Section ContainerClass="flex justify-center mb-20">
        ...
        >
          {t('offpage.btnChineseOffPageSample')}
        </Button>
      </Section>
